...
function _addVersionsMenu(version_data) {
  ...
  var inner_html = inner_html +
        "</dl>" +
        "<hr>" +
        "<small>Generated by <a href='https://goerz.github.io/docs_versions_menu'>Doctr Versions Menu</a>" +
        "</small>" +
      "</div>" +
    "</div>";
  ...
  if (warning !== undefined){
    if (version_data["latest"] !== null){
      msg = msg + " The project has been renamed to " + "<a href='" +
        "https://goerz.github.io/docs_versions_menu" +
        "'>Docs-Versions-Menu</a>."
    }
